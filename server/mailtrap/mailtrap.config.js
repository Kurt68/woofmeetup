...
const useSendingAPI = process.env.USE_MAILTRAP_SENDING === 'true' || isProduction

export const mailtrapClient = new MailtrapClient({
  endpoint: useSendingAPI ? process.env.MAILTRAP_ENDPOINT : undefined,
  token: useSendingAPI ? process.env.MAILTRAP_SENDING_TOKEN : process.env.MAILTRAP_TOKEN,
})
